	...
	switch (event.key) {
		...
		case "A":
            if(+document.getElementById("CUpValue").textContent >= 0.1){
                document.getElementById("CUpValue").textContent = (+document.getElementById("CUpValue").textContent - 0.1).toFixed(2);
                animate()
            }
			break;
		case "d":
		...
		case "W":
            if(+document.getElementById("CVpValue").textContent <= 0.9){
                document.getElementById("CVpValue").textContent = (+document.getElementById("CVpValue").textContent + 0.1).toFixed(2);
                animate()
            }
			break;
		case "s":
